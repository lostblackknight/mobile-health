...
import io.github.lostblackknight.order.filter.TokenInfoFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/payment/notify").permitAll();
        http.authorizeRequests().antMatchers("/**").hasAnyAuthority("admin", "patient");
